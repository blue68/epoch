...
%% The default backoff lookup table for standby duration in seconds.
-define(DEFAULT_STANDBY_TIMES, [5, 15, 30, 60, 120, 300, 600]).
...
rejection_delay(BackoffTable, RejectionCount) ->
    ...
    lists:nth(BackoffIndex, BackoffTable) * 1000.
